	...
	<div class="row">
	    <div class="col-md-12">
	        <div class="panel panel-default">
	            <div class="panel-heading">Data Tugas / Ujian Setiap Mata Kuliah</div>
	        ...
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
					...
					if(mysqli_num_rows($sql_tq) > 0) {
						...
						<div class="alert alert-danger">Data ujian yang berada di kelas ini dengan matkul tersebut tidak ada</div>
						<?php
					} ?>
					</div>
	            </div>
