...
$pdf->Cell(0,5,'Politeknik Gihon','0','1','C',false);
$pdf->SetFont('Arial','i',8);
$pdf->Cell(0,5,'Alamat : Jln. Bahkora II, Pematang Siantar, Indonesia','0','1','C',false);
$pdf->Cell(0,2,'Telp : (xxx) xxxxxx - Email : admin@politeknikgihon.ac.id','0','1','C',false);
$pdf->Ln(3);
