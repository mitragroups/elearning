        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-warning">
                    Admin tidak dapat mengedit data mahasiswa. Admin hanya dapat mengaktifkan dan menonaktifkan serta menghapus akun mahasiswa. Untuk mengedit data mahasiswa yang berhak ialah mahasiswa itu sendiri.
                </div>
            </div>
        </div>
    <?php
